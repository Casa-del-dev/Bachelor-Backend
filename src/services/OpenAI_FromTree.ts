...
1. For each step (and substep) containing content in the Tree:
   ...
   - If a step’s or substep’s **content field is present in the Tree**, you are expected to add the corresponding # Step N comment in the code section. Skipping this is not allowed. You must always mark implemented steps with the correct comment.
