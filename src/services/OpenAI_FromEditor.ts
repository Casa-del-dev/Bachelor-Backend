...
- You **must treat every comment like # Step X, # Step X.Y, or # Step X.Y.Z as defining a step or substep, don't add a description**. These comments are authoritative and must be reflected in the structure of the step tree.
